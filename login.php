        ...
        <div class="col-lg-4 col-md-5 col-sm-6 col-xs-7 mb-5">
          ...
          <div class="card rounded">
            <ul class="nav nav-tabs justify-content-center bg-light" style="padding: 20px;">
              <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#hospitals">Blood Bank</a>
              </li>
              <li class="nav-item">
            ...
            <div class="tab-content">
              <div class="tab-pane container active" id="hospitals">
                <form action="file/hospitalLogin.php" method="post">
                  <label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Blood Bank Email</label>
                  <input type="email" name="hemail" placeholder="Blood Bank Email" class="form-control mb-4" required>
                  <label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Bank Password</label>
                  <input type="password" name="hpassword" placeholder=" Password" class="form-control mb-4" required>
              ...
              <div class="tab-pane container fade" id="receivers">
                <form action="file/receiverLogin.php" method="post">
                  ...
                  <input type="email" name="remail" placeholder="Receiver Email" class="form-control mb-4" required>
                  <label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Receiver Password</label>
                  <input type="password" name="rpassword" placeholder="Receiver Password" class="form-control mb-4" required>
